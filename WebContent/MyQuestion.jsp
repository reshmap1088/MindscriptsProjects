...
<body style="background-color:lightgray">
		...
		<tr>
			...
			<td>
				<div style="margin-left:230px">	
					<a id="sec1" href="Welcome.jsp" style="color: blue;"> All Question </a>
			...
			<td>
				<a id="sec2" href="javascript:void(0);" style="color: green;"> My Question </a>
			</td>
		</tr>
	</table>
	...
	<%	
		...
		try 
		{
			...
			PreparedStatement ps = conn.prepareStatement("select ifnull(a.status,'?'), b.que_id, b.que, count(a.ans_id), b.date_time from question b left join answer a on a.que_id=b.que_id where b.uid='"+id+"' group by b.que_id order by a.ans_id");
