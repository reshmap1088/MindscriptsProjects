...
<body style="background-color:lightgray">
	...
	<%	
		...
		try 
		{
		    ...
		    PreparedStatement ps = conn.prepareStatement("select @s:=@s+1 se, b.que, count(a.ans_id), b.que_id from question b right join answer a on a.que_id=b.que_id group by b.que_id having count(a.ans_id) > '"+ 0 +"' order by a.ans_id");
		   ...
		   %>
		    ...
		    <td>
		    <br>
		    <table id="ans_table" width="550px" height="100px" style="margin-bottom: 320px; margin-top: 15px;" border=1 CELLPADDING=3 CELLSPACING=1 rules="rows" FRAME=HSIDES>
		    	<tr>
	    			<th>No</th>
	    			<th>Answer of Question 1</th>
	    		</tr>
		    	<%		    	
		    	try
	    		{
